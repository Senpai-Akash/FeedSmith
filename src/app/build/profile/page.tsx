...
export default function ProfilePage() {
  const [preferences, setPreferences] = useState<{ interests: { id: string; name: string; strength: number }[] }>({ interests: [] });
  ...
  const description = topThree.length
    ? `Your feed is heavily focused on ${topThree.map(t => t.name).join(", ")}.`
    : "";
